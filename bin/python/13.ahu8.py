...
filepaths = [Path.joinpath(data_path, f'{folder_name1}/{folder_name2}/Mixed Air TempCSV/Mixed Air Temp.csv'),
             Path.joinpath(data_path, f'{folder_name1}/{folder_name2}/PH Air TempCSV/PH Air Temp.csv'),
             ...
             Path.joinpath(data_path, f'{folder_name1}/{folder_name2}/Outside Air ISO Damper StatusCSV/Outside Air ISO Damper Status_resample.csv'),
             ...
             Path.joinpath(data_path, f'{folder_name1}/{folder_name2}/Preheat ValveCSV/Preheat Valve.csv'),
             ...
             Path.joinpath(data_path, f'{folder_name1}/{folder_name2}/OA FlowCSV/OA Flow.csv'),
...
col_names = ['MixedAir(degC)', 'PHAir(degC)', 'ClgCoilAir(degC)', 'SupplyAir(degC)', 'RetAir(degC)', 
             'SupplyHumid(%)', 'ReturnHumid(%)',
             'OADamper(on/off)', 'Economizer(%)', 'ExhAirDamper(%)',
             'PHValve(%)', 'ClgValve(%)', 'HtgValve(%)', 
...
cols2viz = ['MixedAir(degC)', 'ClgCoilAir(degC)', 'SupplyAir(degC)', 'RetAir(degC)', 'PHAir(degC)']
color_ls = ['b', 'c', 'm', 'k', 'y']
linestyle_ls = ['solid', 'solid', 'solid', 'solid', 'solid']

cols2viz2 = ['ClgValve(%)', 'HtgValve(%)', 'PHValve(%)']
color_ls2 = ['b', 'r', 'y']
